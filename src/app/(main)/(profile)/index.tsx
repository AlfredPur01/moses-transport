        ...
        <View style={styles.content}>
          ...
          {profile.virtual_account_number && (
            <View style={styles.section}>
              ...
              <View style={styles.sectionCard}>
                ...
                <InfoRow icon="business-outline" label="Bank" value={profile.virtual_bank_name ?? undefined} />
              </View>
            </View>
          )}
          ...
          <View style={styles.section}>
            ...
            <View style={styles.sectionCard}>
              ...
              {profile.alternate_phone ? <View style={styles.rowDivider} /> : null}
              <InfoRow icon="call-outline" label="Alternate Phone" value={profile.alternate_phone ?? undefined} />
              {profile.email ? <View style={styles.rowDivider} /> : null}
              <InfoRow icon="mail-outline" label="Email" value={profile.email ?? undefined} />
            </View>
          </View>
          ...
          <View style={styles.section}>
            ...
            <View style={[styles.sectionCard, styles.feeRow]}>
              <Ionicons
                name={profile.application_fee_paid ? 'checkmark-circle' : 'alert-circle-outline'}
                size={20}
                color={profile.application_fee_paid ? Colors.success : Colors.error}
              />
              <Text style={[styles.feeTxt, { color: profile.application_fee_paid ? Colors.success : Colors.error }]}>
                {profile.application_fee_paid ? 'Application fee paid' : 'Application fee not yet paid'}
              </Text>
              {!profile.application_fee_paid && (
                ...
                >
                  <Text style={styles.feePayTxt}>Pay Now</Text>
                </TouchableOpacity>
              )}
            </View>
          </View>
...
const styles = StyleSheet.create({
  ...
  feeTxt: { flex: 1, fontSize: Typography.sizes.sm, fontWeight: Typography.weights.medium },
  feePayBtn: {
    paddingHorizontal: Spacing.md, paddingVertical: Spacing.xs,
    borderRadius: BorderRadius.md, backgroundColor: Colors.primary,
  },
  feePayTxt: { fontSize: Typography.sizes.xs, fontWeight: Typography.weights.semibold, color: '#fff' },
});
